...
ALTER TABLE IF EXISTS ONLY lms.video_transcripts DROP CONSTRAINT IF EXISTS video_transcripts_lesson_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.user_progress DROP CONSTRAINT IF EXISTS user_progress_user_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.user_progress DROP CONSTRAINT IF EXISTS user_progress_lesson_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.stripe_customers DROP CONSTRAINT IF EXISTS stripe_customers_user_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.sessions DROP CONSTRAINT IF EXISTS sessions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.mux_data DROP CONSTRAINT IF EXISTS mux_data_lesson_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.modules DROP CONSTRAINT IF EXISTS modules_course_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.lessons DROP CONSTRAINT IF EXISTS lessons_module_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.enrollments DROP CONSTRAINT IF EXISTS enrollments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.enrollments DROP CONSTRAINT IF EXISTS enrollments_course_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.courses DROP CONSTRAINT IF EXISTS courses_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.courses DROP CONSTRAINT IF EXISTS courses_category_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.course_media DROP CONSTRAINT IF EXISTS course_media_course_id_fkey;
ALTER TABLE IF EXISTS ONLY lms.attachments DROP CONSTRAINT IF EXISTS attachments_course_id_fkey;
DROP INDEX IF EXISTS lms.idx_video_transcripts_lesson_id;
DROP INDEX IF EXISTS lms.idx_user_progress_user_id;
DROP INDEX IF EXISTS lms.idx_user_progress_lesson_id;
DROP INDEX IF EXISTS lms.idx_user_progress_is_completed;
DROP INDEX IF EXISTS lms.idx_stripe_customers_user_id;
DROP INDEX IF EXISTS lms.idx_stripe_customers_stripe_customer_id;
DROP INDEX IF EXISTS lms.idx_mux_data_playback_id;
DROP INDEX IF EXISTS lms.idx_mux_data_lesson_id;
DROP INDEX IF EXISTS lms.idx_mux_data_asset_id;
DROP INDEX IF EXISTS lms.idx_modules_position;
DROP INDEX IF EXISTS lms.idx_modules_course_id;
DROP INDEX IF EXISTS lms.idx_lessons_position;
DROP INDEX IF EXISTS lms.idx_lessons_module_id;
DROP INDEX IF EXISTS lms.idx_lessons_is_published;
DROP INDEX IF EXISTS lms.idx_lessons_is_free;
DROP INDEX IF EXISTS lms.idx_enrollments_user_course;
DROP INDEX IF EXISTS lms.idx_course_id;
DROP INDEX IF EXISTS lms.idx_category_id;
ALTER TABLE IF EXISTS ONLY lms.video_transcripts DROP CONSTRAINT IF EXISTS video_transcripts_pkey;
ALTER TABLE IF EXISTS ONLY lms.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY lms.users DROP CONSTRAINT IF EXISTS users_email_key;
ALTER TABLE IF EXISTS ONLY lms.user_progress DROP CONSTRAINT IF EXISTS user_progress_user_id_lesson_id_key;
ALTER TABLE IF EXISTS ONLY lms.user_progress DROP CONSTRAINT IF EXISTS user_progress_pkey;
ALTER TABLE IF EXISTS ONLY lms.stripe_customers DROP CONSTRAINT IF EXISTS stripe_customers_user_id_key;
ALTER TABLE IF EXISTS ONLY lms.stripe_customers DROP CONSTRAINT IF EXISTS stripe_customers_stripe_customer_id_key;
ALTER TABLE IF EXISTS ONLY lms.stripe_customers DROP CONSTRAINT IF EXISTS stripe_customers_pkey;
ALTER TABLE IF EXISTS ONLY lms.sessions DROP CONSTRAINT IF EXISTS sessions_token_key;
ALTER TABLE IF EXISTS ONLY lms.sessions DROP CONSTRAINT IF EXISTS sessions_pkey;
ALTER TABLE IF EXISTS ONLY lms.mux_data DROP CONSTRAINT IF EXISTS mux_data_pkey;
ALTER TABLE IF EXISTS ONLY lms.modules DROP CONSTRAINT IF EXISTS modules_pkey;
ALTER TABLE IF EXISTS ONLY lms.migrations DROP CONSTRAINT IF EXISTS migrations_pkey;
ALTER TABLE IF EXISTS ONLY lms.lessons DROP CONSTRAINT IF EXISTS lessons_pkey;
ALTER TABLE IF EXISTS ONLY lms.enrollments DROP CONSTRAINT IF EXISTS enrollments_user_id_course_id_key;
ALTER TABLE IF EXISTS ONLY lms.enrollments DROP CONSTRAINT IF EXISTS enrollments_pkey;
ALTER TABLE IF EXISTS ONLY lms.courses DROP CONSTRAINT IF EXISTS courses_pkey;
ALTER TABLE IF EXISTS ONLY lms.course_media DROP CONSTRAINT IF EXISTS course_media_pkey;
ALTER TABLE IF EXISTS ONLY lms.categories DROP CONSTRAINT IF EXISTS categories_pkey;
ALTER TABLE IF EXISTS ONLY lms.categories DROP CONSTRAINT IF EXISTS categories_name_key;
ALTER TABLE IF EXISTS ONLY lms.attachments DROP CONSTRAINT IF EXISTS attachments_pkey;
ALTER TABLE IF EXISTS lms.migrations ALTER COLUMN id DROP DEFAULT;
DROP TABLE IF EXISTS lms.video_transcripts;
DROP TABLE IF EXISTS lms.users;
DROP TABLE IF EXISTS lms.user_progress;
DROP TABLE IF EXISTS lms.stripe_customers;
DROP TABLE IF EXISTS lms.sessions;
DROP TABLE IF EXISTS lms.mux_data;
DROP TABLE IF EXISTS lms.modules;
DROP SEQUENCE IF EXISTS lms.migrations_id_seq;
DROP TABLE IF EXISTS lms.migrations;
DROP TABLE IF EXISTS lms.lessons;
DROP TABLE IF EXISTS lms.enrollments;
DROP TABLE IF EXISTS lms.courses;
DROP TABLE IF EXISTS lms.course_media;
DROP TABLE IF EXISTS lms.categories;
DROP TABLE IF EXISTS lms.attachments;
